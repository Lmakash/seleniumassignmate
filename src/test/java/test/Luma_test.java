	  ...
	  public void f(String fname, String lname,String email, String pass, String upass) throws Exception {
		  ...
		  if(title.equals("Create New Customer Account"))
			...
			else
			{
				...
				File dfile = new File("C:\\Users\\akash.shendage\\eclipse-workspace\\JAN2024_seleniumweb1\\lumatitle.png");
			...
			else
			{
				...
				File dfile1 = new File("C:\\Users\\akash.shendage\\eclipse-workspace\\JAN2024_seleniumweb1\\userverify.png");
			...
			else
			{
				...
				File dfile2 = new File("C:\\\\Users\\\\akash.shendage\\\\eclipse-workspace\\\\JAN2024_seleniumweb1\\\\passverify.png");
...
//		  //js.executeAsyncScript("window.scrollBy(0,document.body.scrollHeight)");
		  ...
		  if(obj.verifylogin())
			...
			else
			{
				...
				File dfile3 = new File("C:\\Users\\akash.shendage\\eclipse-workspace\\JAN2024_seleniumweb1\\verifylogin.png");
...
//				}
	  ...
	  public Object[][] dp() throws Exception {
		  File f1 = new File("C:\\Users\\akash.shendage\\eclipse-workspace\\JAN2024_seleniumweb1\\luma_register.xlsx");
